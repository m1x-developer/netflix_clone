            ...
            <div className="nav-links d-flex flex-center flex-middle align-items-center">
                <nav className='d-flex space-between align-items-center'>
                    ...
                    <div className='nav-links'>
                        <Link to={'/homepage'} className="nav-item home">Home</Link>
                        <Link to={'/'} className="nav-item home">TV Show</Link>
                        <Link to={'/'} className="nav-item home">Movies</Link>
                        <Link to={'/'} className="nav-item home">Latest</Link>
                        <Link to={'/'} className="nav-item home">My List</Link>
                    </div>
                </nav>
            ...
            <div className="righticons d-flex flex-end flex-middle align-items-center">
                ...
                <div className="dropdown notification">
                    ...
                    <div className="dropdown-content">
                        <Link to={'/homepage'} className="nav-item home">
                            <img src={searchSVG} width={'25px'} alt="userprofileicon" className="user-icon"/>
                    ...
                    <div>
                        ...
                        <div className="dropdown-content">
                            ...
                            <div className="links d-flex direction-column">
                                ...
                                <button onClick={() => {exit()}}>Sign Out of Netflix</button>
                            </div>
